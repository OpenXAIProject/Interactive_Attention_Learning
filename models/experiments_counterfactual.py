...
def Find_influential_training_input(model, 
    ...
    with open(os.path.join(result_folder, stage+task+'_Samples_IF_Counterfactual.pickle'), 'wb') as handle:
...
def further_stage_Find_influential_training_input(model, 
    ...
    # result_folder = os.path.join('/st2/Jayheo/ICML2020/IAL_cerebral1/Samples', task)
